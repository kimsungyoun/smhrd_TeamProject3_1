...
public class KakaoLoginService {
	...
	public String getAccessToken (String authorize_code) {
		...
		try {
			...
			sb.append("&client_id=	e831a7e679907c101406dcf9f7babc4b"); //본인이 발급받은 key
			sb.append("&redirect_uri="); // 본인이 설정한 주소
	...
	public KakaoDTO getKakaoInfoService(String access_Token){
