...
<main>
	...
	<%--구글 api--%>
	<div id="g_id_onload" data-client_id="509029365873-e1n6bo3edjb0h0brf50dl08hfpf2dj4s.apps.googleusercontent.com" data-login_uri= "<%= request.getContextPath() %>" data-auto_prompt="false"></div>
